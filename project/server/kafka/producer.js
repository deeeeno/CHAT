...
function send(topicID,message){
    return new Promise((resolve,reject)=>{
        producer.send([{'topic':topicID, 'messages':message}],(err,data)=>{
            if(err!=null)
...
module.exports = {
    createTopic : function(id){
        producer.createTopics([id], false, function (err, result) {
            return (err!=null) ? err : result;
        });
    },
